    ...
    return (
      <View style={styles.orderCard}>
        ...
        <View style={styles.orderDetails}>
          ...
          <Text style={styles.detailValue}>KES {item.total}</Text>
        </View>
        ...
        <Text style={styles.itemsCount}>{item.items?.length || 0} item(s)</Text>
      </View>
    );
  };
