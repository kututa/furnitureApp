...
const styles = StyleSheet.create({
	...
	filterBtnText: { color: "#7CB798", fontWeight: "bold", fontSize: 14 },
	dropdownOverlay: {
		position: "absolute",
		top: 0,
		left: 0,
	...
	dropdownItem: { paddingVertical: 12, paddingHorizontal: 24, borderRadius: 8 },
	dropdownText: { fontSize: 16, color: "#222", textAlign: "center" },
	card: {
		backgroundColor: "#fff",
		borderRadius: 12,
		marginBottom: 14,
	...
	rateBtnText: { color: "#111", fontWeight: "bold", fontSize: 16 },
	cartBadge: {
		position: "absolute",
		top: -6,
		right: -10,
